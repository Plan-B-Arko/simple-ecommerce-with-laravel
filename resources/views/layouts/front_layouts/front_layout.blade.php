            ...
            <div class="site-header__topbar topbar">
                <div class="topbar__container container">
                    <div class="topbar__row">
                        <div class="topbar__item topbar__item--link"><a class="topbar-link" href="{{ route('about') }}">About Us</a></div>
                        <div class="topbar__item topbar__item--link"><a class="topbar-link" href="{{ route('contact') }}">Contacts</a></div>
                        <div class="topbar__spring"></div>
                        <div class="topbar__item">
                            <div class="topbar__item topbar__item--link"><a class="topbar-link" href="{{ route('account') }}">Login</a></div>
                            <div class="topbar__item topbar__item--link"><a class="topbar-link" href="{{ route('account') }}">Registration</a></div>
                        </div>
                    </div>
                </div>
            </div>
                                ...
                                <ul class="nav-links__list">
                                    ...
                                    <li class="nav-links__item nav-links__item--with-submenu"><a href=""><span>Baby Food <i class="fa fa-angle-down p-1" aria-hidden="true"></i></span></a>
                                        <div class="nav-links__menu">
                                            <ul class="mobile-links mobile-links--level--1">
                                                @foreach($submenus as $submenu)
                                                    @if($submenu->maincategory == 'Baby' && $submenu->status == 0)
                                                        <li class="mobile-links__item" data-collapse-item>
                                    ...
                                    <li class="nav-links__item nav-links__item--with-submenu"><a href=""><span>Adult Food <i class="fa fa-angle-down p-1" aria-hidden="true"></i></span></a>
                                        <div class="nav-links__menu">
                                            <ul class="mobile-links mobile-links--level--1">
                                                @foreach($submenus as $submenu)
                                                    @if($submenu->maincategory == 'Adult' && $submenu->status == 0)
                                                        <li class="mobile-links__item" data-collapse-item>
                                                            <div class="mobile-links__item-title"><a href="{{ url('product/category/'.$submenu->id) }}" class="mobile-links__item-link">{{ $submenu->name }}</a></div>
                                                        </li>
                                                    @endif
                                    ...
                                    <li class="nav-links__item nav-links__item--with-submenu"><a href=""><span>Aged Food <i class="fa fa-angle-down p-1" aria-hidden="true"></i></span></a>
                                        <div class="nav-links__menu">
                                            <ul class="mobile-links mobile-links--level--1">
                                                @foreach($submenus as $submenu)
                                                    @if($submenu->maincategory == 'Aged' && $submenu->status == 0)
                                                        <li class="mobile-links__item" data-collapse-item>
                                                            <div class="mobile-links__item-title"><a href="{{ url('product/category/'.$submenu->id) }}" class="mobile-links__item-link">{{ $submenu->name }}</a></div>
                                                        </li>
                                                    @endif
                    ...
                    <div class="row">
                        <div class="col-12 col-md-6 col-lg-4">
                            <div class="site-footer__widget footer-contacts">
                                ...
                                <ul class="footer-contacts__contacts">
                                    ...
                                    <li><i class="footer-contacts__icon far fa-envelope"></i> admin@royalfood.com</li>
                                    <li><i class="footer-contacts__icon fas fa-mobile-alt"></i> 017XX XXX XXX</li>
                                </ul>
                            </div>
                        </div>
                        <div class="col-6 col-md-3 col-lg-2">
                            <div class="site-footer__widget footer-links">
                                ...
                                <ul class="footer-links__list">
                                    <li class="footer-links__item"><a href="{{ route('about') }}" class="footer-links__link">About Us</a></li>
                        ...
                        <div class="col-6 col-md-3 col-lg-2">
                            <div class="site-footer__widget footer-links">
                                ...
                                <ul class="footer-links__list">
                                    <li class="footer-links__item"><a href="{{ route('order_list') }}" class="footer-links__link">Order History</a></li>
                                </ul>
                            </div>
                        </div>
